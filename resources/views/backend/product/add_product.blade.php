                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_urdu" value="Lorem,Ipsum,Amet" data-role="tagsinput" class="form-control">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_en" value="Lorem,Ipsum,Amet" data-role="tagsinput" class="form-control">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_size_urdu" value="Lorem,Ipsum,Amet" data-role="tagsinput" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_color_urdu" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_en" class="form-control" placeholder="Enter short description about the product..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_urdu" class="form-control" placeholder="پروڈکٹ کے بارے میں مختصر تفصیل درج کریں..."></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor1" name="long_descp_en" rows="10" cols="80">Enter Long description about the product.</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor2" name="long_descp_urdu" rows="10" cols="80">پروڈکٹ کے بارے میں مختصر تفصیل درج کریں.</textarea>
                                                </div>
                                            </div>
                                        </div>
