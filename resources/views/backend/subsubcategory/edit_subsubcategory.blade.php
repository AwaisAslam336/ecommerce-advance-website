            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form method="POST" action="{{route('update_subsubcategory')}}" novalidate>
                                @csrf
                                <input name="id" type="hidden" value="{{ $subsubcategory->id }}">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="subsubcategory_name_urdu" value="{{$subsubcategory->subsubcategory_name_urdu}}" class="form-control">
